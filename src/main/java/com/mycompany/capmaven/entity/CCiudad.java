...
@NamedQueries({
    ...
    @NamedQuery(name = "CCiudad.findByLadaActiva", query = "SELECT c FROM CCiudad c WHERE c.lada = :lada and c.activo = true"),
...
public class CCiudad implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.capmaven.entity.CCiudad[ idCiudad=" + idCiudad + " ]";
    }
