...
@NamedQueries({
    ...
    @NamedQuery(name = "HActivacion.findBetweenFechas", query = "SELECT h FROM HActivacion h WHERE h.fechaPeticion between :fechaInicio AND :fechaFin"),
...
public class HActivacion implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.capmaven.entity.HActivacion[ id=" + id + " ]";
    }
